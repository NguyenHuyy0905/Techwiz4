...
const OrderList = () => {
            ...
            Object.keys(data).map((keys, i) => (
                <>
                    ...
                    <tr className="my-10">
                        ...
                        <td className='w-1/12 border border-solid'><img src={data_product.thumb_image_url}></img></td>
                        <td className='w-1/12 border border-solid'>{data_product.quantity}</td>
                        <td className='w-1/12 border border-solid'>{<e>
                            
                            </e>}</td>
                        <td className='w-q/12 border border-solid'>{data_product.status}</td>
                        <td className='w-1/12 border border-solid'>
                            <select className="bg-gray-300 outline-none text-center" onChange={(e) => setSelectedOption(e.target.value)} >
    ...
    return (
        ...
        <div className="overflow-x">
            <div className='my-9'>
                <h1 className="text-center font-extrabold text-4xl py-0">
                    Order List
                </h1>
            </div>
